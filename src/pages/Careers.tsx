...
const jobOpenings = [
  {
    title: "Business Development Associate (BDA)/ Business Development Manager (BDM)",
    location: "Gurgaon",
    type: "Full-time",
    department: "Sales",
    description: "We are looking for a dynamic Sales Associate to handle property sales, client meetings, and site visits.",
    responsibilities: [
  ...
  {
    title: "Client Relationship Associate / Tele Sales Associate",
    location: "Gurgaon",
    type: "Full-time",
    department: "Customer Support & Sales",
    description: "We are hiring Telecallers to manage leads, follow up with clients, and generate site visit appointments.",
    responsibilities: [
...
const Careers = () => {
  ...
  const [bgImage, setBgImage] = useState("/career-desktop.jpeg");

  // Handle responsive background image
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        setBgImage("/career-mobile.jpeg");
      } else {
        setBgImage("/career-desktop.jpeg");
      }
    };
    ...
    <Layout>
                  ...
                  <div className="p-8 pt-0 border-t border-slate-50">
                    <div className="grid md:grid-cols-2 gap-10 mt-8">
                      ...
                      <div>
                        ...
                        <div className="mt-8">
                          <a href={`mailto:careers@tandtrealty.com?subject=Application for ${job.title}`}>
      ...
      <section className="py-20 bg-[#031916] text-white">
        <div className="container-custom text-center">
          ...
          <a href="mailto:careers@tandtrealty.com">
