          ...
          <div className="container-custom w-full pb-10 md:pb-0">
            <div className="max-w-3xl">
              ...
              <p className="text-white/80 mt-3 md:mt-4 max-w-2xl text-base md:text-lg">
                xPT and T Realty is a Gurgaon-based real estate advisory firm offering end-to-end expertise across residential, commercial, land, mixed-use, and investment assets.
              </p>
