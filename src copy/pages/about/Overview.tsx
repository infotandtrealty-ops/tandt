          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <span className="inline-block px-4 py-2 bg-gold/10 text-gold rounded-full text-sm font-medium">
                Welcome to T and T Realty
              </span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground">
                About Our Company
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                T and T Realty Services Private Limited is a leading consultancy company incorporated in 2014 to drive Social and Economic Growth through REAL ESTATE by safeguarding the Future and creating a Brighter World for Customers, Partners, Communities, and the Environment.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                T and T, the name being derived from the <span className="text-gold font-semibold">Trust</span> of its stakeholders and <span className="text-gold font-semibold">Transparency</span> that it adheres to in all its transactions. With more than 15 years of Professional and Corporate experience, its Founders Mr. Ashish Thapar and Mr. Gurpreet Ratra in the world of Real Estate and Infrastructure have acquired in-depth knowledge of Projects and Solutions.
              </p>
