...
const testimonials = [
  ...
  },
  {
    ...
    text: "The team was very professional and helped me find the perfect property within my budget. Their transparent process is what I liked the most."
  },
  {
    id: 3,
    name: "Vikram Malhotra",
    image: "/reviews/3.webp",
    text: "Great experience working with T and T Realty. They handle all the paperwork smoothly and make the buying process stress-free."
  },
  {
    id: 4,
    name: "Dr. Rahul Kakkar",
    image: "/reviews/4.webp",
    text: "I was looking for a home for months, but T and T Realty made it happen in weeks. Excellent service and very trustworthy people."
  }
];
